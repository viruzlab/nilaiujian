...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/jadwal/zip-init', [\App\Http\Controllers\Admin\JadwalSidangController::class, 'initZip'])->name('jadwal.zip-init');
    Route::post('/jadwal/zip-process', [\App\Http\Controllers\Admin\JadwalSidangController::class, 'processZip'])->name('jadwal.zip-process');
    Route::get('/jadwal/zip-download', [\App\Http\Controllers\Admin\JadwalSidangController::class, 'downloadZip'])->name('jadwal.zip-download');
